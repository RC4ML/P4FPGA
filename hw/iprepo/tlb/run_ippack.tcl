...
set sdx_kernel_name "tlb"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/amax/hhj/example_module/xdma/build/hls/tlb/tlb_prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {tlb_tlb_table_padbkb
regslice_core
tlb
}
set kernel_xo ""
...
set Interfaces {
    ap_clk {
        ...
        buses "s_axis_mem_write_cmd_V s_axis_mem_read_cmd_V m_axis_dma_write_cmd_V m_axis_dma_read_cmd_V s_axis_tlb_interface_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    s_axis_mem_write_cmd_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_mem_write_cmd_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    s_axis_mem_read_cmd_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_mem_read_cmd_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    m_axis_dma_write_cmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_dma_write_cmd_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    m_axis_dma_read_cmd_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_dma_read_cmd_V"
        has_tready "1"
        ports {
            TDATA 96
        }
    ...
    s_axis_tlb_interface_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_tlb_interface_V"
        has_tready "1"
        ports {
            TDATA 136
        }
...
## System Info
set user_parameters_list {clk_period 3.2 machine 64 combinational 0 latency 3 II 1}
